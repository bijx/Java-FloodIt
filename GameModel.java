...
public class GameModel {
    ...
    //public static ArrayList<DotInfo> dots = new ArrayList<DotInfo>();
    ...
    private static void createBoard(){
    	...
    	for(int x = 0; x<boardSize; x++){
    		for(int y = 0; y<boardSize; y++){
    			dots[x][y] = new DotInfo(x,y,rand.nextInt(6));  
    			//System.out.println(dots[x][y].getColor());
    		}
    	}

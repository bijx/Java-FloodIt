...
public class DotButton extends JButton {
	...
	private static int row, column, color, iconSize;
    ...
    public DotButton(int row, int column, int color, int iconSize) {
    	...
    	ico = new ImageIcon("data/" + size + "/ball-"+color+".png");
    	this.setIcon(ico);
    	setOpaque(false);
 ...
 /**
    ...
    public DotButton(int color, int iconSize) {
    	...
    	//ico = new ImageIcon("C:\\Users\\Test\\Desktop\\data\\N\\ball-0.png");
    ...
    public void setColor(int color) {
    	this.color = color;
    	ico = new ImageIcon("data/" + "S" + "/ball-"+color+".png");
    	this.setIcon(ico);
   }
